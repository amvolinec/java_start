        ...
        do {
            ...
            switch (operator) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    System.out.println("Iveskite islaidu ieskoma suma ir buda");
                    IslaiduIrasas islaiduIrasas = b1.gautiIslaiduIrasa(scanner.nextDouble(), scanner.next());
                    System.out.println(islaiduIrasas);
                    break;
                case 6:
                    System.out.println("Iveskite pajamu ieskoma suma ir kategorija");
                    PajamuIrasas pajamuIrasas = b1.gautiPajamuIrasa(scanner.nextDouble(), scanner.nextInt());
